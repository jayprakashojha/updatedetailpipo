...
import org.springframework.ui.Model;
	...
	public class MyController {
	    ...
	    public ModelAndView message(@RequestParam String name,
	                                @RequestParam String occupation,RedirectAttributes atts) {

	        var msg = String.format("%s is a Great %s", name, occupation);

	        Map<String, Object> params = new HashMap<>();
	        params.put("message", msg);
	        atts.addFlashAttribute("message", "successfully inserted record");
	    ...
	    public RedirectView handleError(ConstraintViolationException ex,
	        ...
	        if (!StringUtils.isEmptyOrWhitespace(name)) {
	            atts.addFlashAttribute("name", "successfully inserted record");
	        }
